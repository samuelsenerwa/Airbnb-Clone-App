                            ...
                            <ScrollView
                                ...
                                {places.map((item, index) => (
                                    <TouchableOpacity onPress={() => setSelectedPlace(index)} key={index}>
                                        ...
                                        />
                                        <Text style={{ fontFamily: 'lex', paddingTop: 6 }}>{item.title}</Text>
                                    </TouchableOpacity>
                                ))}
                            </ScrollView>
                        </Animated.View>
                        ...
                        <Animated.View style={styles.cardBody}>
                            {groups.map((item, index) => (
                                <View
                                    ...
                                    <View>
                                        <Text style={{ fontFamily: 'lex-semi', fontSize: 14 }}>{item.name}</Text>
                                        <Text style={{ fontFamily: 'lex', fontSize: 14, color: Colors.grey }}>
                                            {item.text}
                                        </Text>
                                    </View>
